...
\fancyhead[C]{Evolutionary optimization algorithms $\bullet$ MK - Einführung in das wissenschaftliche Arbeiten} % Custom header text
...
\title{Evolutionary optimization algorithms} % Article title
\author{
