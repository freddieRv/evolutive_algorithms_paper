...
Eine der wichtigste und schwersten Teile der Optimierung ist, eine geeignete Zielfunktion zu definieren, die alle die wichtige zu optimieren Faktore berücksichtigt.
Probleme im wirklichen Leben sind normalerweise Eingeschränkt, multi-Objective und multi-modale, oder mit eine hoch Anzahl von Dimensionen.
%------------------------------------------------
